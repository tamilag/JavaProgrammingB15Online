...
public class StringArrayPractice_1000Cars {
...
String carInventory []=new String[] {
        ...
        for (int x = 0; x < carInventory.length; x++) {
            if (carInventory[x].contains("Chevrolet")) {
            }
            chevy++;
            if (carInventory[x].contains("Civic")) {
            }
        }
        ...
        //task 3: print all locations of Honda-Civic
//        for (int i = 0; i <carInventory.length ; i++) {
//            if (carInventory[i].equals("Honda-Civic")){
//                System.out.println("Civic found at location: "+i);
//            }
//        }

     //   task 4: Print make and Model separately , print only Honda make cars
...
//        System.out.println("Car make is "+eachCarSplit[0]+"\nCar model is "+eachCarSplit[1]);
        for (String eachCar:carInventory) {
            if (eachCar.startsWith("Jaguar")) { //optional if you want to change honda to somth else
                String[] eachCarSplit = eachCar.split("-");
                System.out.println("Car make is  " + eachCarSplit[0] + " Car model is " + eachCarSplit[1]);
            }
        }

        // task 5: find all the cars with model has only 2 characters
        // print them out
        // get the count
        int carCount=0;
        for (String eachCar:carInventory) {
        ...
        System.out.println("Car with 2 characters model count is: "+ carCount);

        //sort and print cars with
        System.out.println("Sort------------------------");
        Arrays.sort(carInventory);
        System.out.println("cars sorted: " + Arrays.toString(carInventory));
